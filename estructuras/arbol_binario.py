class NodoArbol:
    """Cada caja del árbol. Tiene UN dato (objeto Juego) y hasta DOS hijos."""

    def __init__(self, dato):
        self.dato = dato          # Guarda el objeto Juego completo
...
class ArbolBST:
    ...
    def insertar(self, dato, clave):
        """Agrega un elemento usando clave(dato) para ordenar (ej: lambda j: j.get_nombre().lower())."""
    ...
    def buscar(self, valor, clave):
        """Busca por valor de clave. Devuelve el elemento Juego o None si no existe."""
    ...
    # ---------- RECORRIDOS ----------
    def inorder(self):
        """Izquierda → raíz → derecha. Devuelve los juegos ORDENADOS alfabéticamente."""
        resultado = []
